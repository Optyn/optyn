...
RailsAdmin.config do |config|
  ...
  config.included_models = ['Admin', 'Shop', 'Connection', 'Shop', 'Manager', 'Business', 'Label', 'Location', 'Survey', 'SurveyQuestion', 'SurveyAnswer', 'Message', 'MessageLabel', 'MessageEmailAuditor', 'MessageUser', 'FileImport',  'User', 'Authentication', 'PermissionUser', "Permission", 'UserLabel', 'Plan', "AppSetting","Partner"]
