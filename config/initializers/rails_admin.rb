...
RailsAdmin.config do |config|
  ...
  config.included_models = ['Admin', 'State', 'Shop', 'Connection', 'Shop', 'Manager', 'Business', 'Label', 'Location', 'Survey', 'SurveyQuestion', 'SurveyAnswer', 'Message', 'MessageLabel', 'MessageEmailAuditor', 'MessageUser', 'MessageFolder', 'FileImport',  'User', 'Authentication', 'PermissionUser', "Permission", 'UserLabel']
