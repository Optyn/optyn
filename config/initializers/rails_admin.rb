# RailsAdmin config file. Generated on April 16, 2013 20:47
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Optyn', 'Admin']
  ...
  config.included_models = ['Admin', 'State', 'Shop', 'Connection', 'Shop', 'Manager', 'Business', 'Label', 'Location', 'Survey', 'SurveyQuestion', 'SurveyAnswer', 'Message', 'MessageLabel', 'MessageEmailAuditor', 'MessageUser', 'MessageFolder', 'FileImport',  'User', 'Authentication', 'PermissionUser', "Permission", 'UserLabel', 'Plan', "AppSetting"]
  ...
  #     configure :account, :polymorphic_association 
  ...
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :account_type, :string         # Hidden 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your connection.rb model definition
  ...
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :connected_via, :string 
  ...
  #     configure :holder, :polymorphic_association 
  #     configure :business, :belongs_to_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :holder_id, :integer         # Hidden 
  #     configure :holder_type, :string         # Hidden 
  ...
  #     configure :shop, :belongs_to_association 
  #     configure :user_labels, :has_many_association 
  ...
  #     configure :id, :integer 
  #     configure :street_address1, :string 
  #     configure :street_address2, :string 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your permission.rb model definition

  #   # Found associations:

  #     configure :permissions_users, :has_many_association 
  ...
  # config.model 'PermissionsUser' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your permissions_user.rb model definition

  #   # Found associations:

  #     configure :permission, :belongs_to_association 
  #     configure :user, :belongs_to_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :permission_id, :integer         # Hidden 
  #     configure :user_id, :integer         # Hidden 
  ...
  #     configure :managers, :has_many_association 
  #     configure :locations, :has_many_association 
  #     configure :oauth_application, :has_one_association         # Hidden 
  #     configure :connections, :has_many_association 
  #     configure :users, :has_many_association 
  #     configure :survey, :has_one_association 
  #     configure :businesses, :has_many_association 
  ...
  #     configure :logo_img, :carrierwave 
  #     configure :business_category, :string 
  ...
  #     configure :shop, :belongs_to_association 
  #     configure :survey_questions, :has_many_association 
  #     configure :survey_answers, :has_many_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :title, :string 
  #     configure :ready, :boolean 
  #     configure :shop_id, :integer         # Hidden 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  # config.model 'SurveyAnswer' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your survey_answer.rb model definition

  #   # Found associations:

  #     configure :survey_question, :belongs_to_association 
  #     configure :user, :belongs_to_association 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your survey_question.rb model definition
  ...
  #     configure :element_type, :string 
  #     configure :label, :text 
  #     configure :values, :serialized 
  #     configure :default_text, :string 
  #     configure :show_label, :boolean 
  ...
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :office_zip_code, :string 
  #     configure :home_zip_code, :string 
  #     configure :zip_prompted, :boolean 
  ...
  # config.model 'UserLabel' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your user_label.rb model definition

  #   # Found associations:

  #     configure :user, :belongs_to_association 
  #     configure :label, :belongs_to_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :user_id, :integer         # Hidden 
  #     configure :label_id, :integer         # Hidden 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
