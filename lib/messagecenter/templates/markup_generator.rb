        ...
        if component.has_key? :social_sharing
          ...
          if social_sharing.has_key? :fb_sharing
            ...
            fb_html = if facebook.html.present? 
                        "<div class='optyn-fbshare'><a href = #{get_social_share_link('facebook',facebook.text, facebook.url)} style= 'background: #3a589b;background:rgba(58, 88, 155, 0.6);color: #fff;height: 20px;text-decoration:none;font-size:12px;line-height:20px;display:inline-block;' target ='_blank'> #{facebook.html}
                        &nbsp; </a></div>" 
                      else
          ...
          if component.social_sharing.has_key? :twitter_sharing
            ...
            twitter_html = if twitter.html.present?
                            "<div class='optyn-twittershare'><a href = #{get_social_share_link('twitter', twitter.text, twitter.url)} style= 'background:#598dca;background:rgba(89, 141, 202, 0.6);color: #fff;height: 20px;text-decoration:none;font-size:12px;line-height:20px;display:inline-block;' target ='_blank'> #{twitter.html}
                            </a></div>"
                          else
