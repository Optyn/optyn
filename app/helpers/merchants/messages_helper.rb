module Merchants::MessagesHelper
  ...
  def get_default_html(type)
    ...
    when "twitter"
      return "<a href = #{get_social_share_link('twitter', 'optyn', SiteConfig.email_app_base_url)} style='background:#598dca;float:left;color: #fff;height: 50px;padding-top:4px;text-decoration:none;width: 50%;' target ='_blank' class = 'optyn-twittershare'>
