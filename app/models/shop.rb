...
class Shop < ActiveRecord::Base
  ...
  attr_accessible :name, :stype, :managers_attributes, :managers, :locations_attributes, :description, :logo_img, :business_ids, :website, :identifier, :time_zone, :virtual, :header_background_color, :phone_number
