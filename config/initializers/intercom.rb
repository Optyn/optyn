IntercomRails.config do |config|
  # == Intercom app_id
  # 
  config.app_id = ENV["INTERCOM_APP_ID"] || "ce25574ac4509a5235a655ee0c10649970d5b815"

  # == Intercom secret key 
  # This is required to enable secure mode, you can find it on your Intercom 
  # "security" configuration page.
  # 
  config.api_secret = "1KiRcf7gEc0V8R9sFH5lbzQAn13W4KwwFE1DBTuy"
  ...
  #
  config.api_key = "6378670ac81d16bbb52f599f055d4b4b7aeec8e4"
  ...
  #
  config.user.current = Proc.new { current_manager }
